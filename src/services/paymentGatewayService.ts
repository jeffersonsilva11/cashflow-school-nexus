...
const formatTransactionDateToString = (transaction: PaymentGatewayTransaction): PaymentGatewayTransaction => {
...
export const paymentGatewayService = {
  ...
  async processTransaction(payload: TransactionPayload): Promise<PaymentGatewayTransaction> {
    try {
      ...
      const transaction: PaymentGatewayTransaction = {
      ...
      const formattedTransaction = formatTransactionDateToString(transaction);
